  ...
  return (
    ...
    <Card className="mb-6">
      ...
      <CardContent>
        ...
        <div className="mt-4">
          <a href="https://github.com/Murtazah1/FedererProjectR" target="_blank" className="text-blue-500 hover:underline">
            View on GitHub
          </a>
          <br />
    ...
    <Card className="mb-6">
      ...
      <CardContent>
        ...
        <div className="mt-4">
          <a href="https://github.com/Murtazah1/3380DataBaseProject" target="_blank" className="text-blue-500 hover:underline">
            View on GitHub
          </a>
          <br />
